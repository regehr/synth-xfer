"func.func"() ({
  ^0(%lhs : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %rhs : !transfer.abs_value<[!transfer.integer, !transfer.integer]>):
    ...
    %const_res1 = "transfer.smin"(%lhs1, %rhs1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %res0_lhs_smax = "transfer.select"(%lhs_is_smax, %rhs0, %const0) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %res1_lhs_smax = "transfer.select"(%lhs_is_smax, %rhs1, %const0) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %res0_rhs_smax = "transfer.select"(%rhs_is_smax, %lhs0, %res0_lhs_smax) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %res1_rhs_smax = "transfer.select"(%rhs_is_smax, %lhs1, %res1_lhs_smax) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer

    %res0_lhs_smin = "transfer.select"(%lhs_is_smin, %smin_not, %res0_rhs_smax) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %res1_lhs_smin = "transfer.select"(%lhs_is_smin, %smin, %res1_rhs_smax) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %res0_rhs_smin = "transfer.select"(%rhs_is_smin, %smin_not, %res0_lhs_smin) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %res1_rhs_smin = "transfer.select"(%rhs_is_smin, %smin, %res1_lhs_smin) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer

    %res0 = "transfer.select"(%both_const, %const_res0, %res0_rhs_smin) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %res1 = "transfer.select"(%both_const, %const_res1, %res1_rhs_smin) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
...
}) {"sym_name" = "kb_smin", "function_type" = (!transfer.abs_value<[!transfer.integer, !transfer.integer]>, !transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> !transfer.abs_value<[!transfer.integer, !transfer.integer]>} : () -> ()
