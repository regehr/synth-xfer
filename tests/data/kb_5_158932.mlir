"func.func"() ({
  ^0(%x : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %s : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %z : !transfer.abs_value<[!transfer.integer, !transfer.integer]>):
    ...
    %lhs0 = "transfer.get"(%z) {index = 0} : (!transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> !transfer.integer
    %lhs1 = "transfer.get"(%z) {index = 1} : (!transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> !transfer.integer
    ...
    %has_feasible_pair = "arith.andi"(%inputs_consistent, %const_true) : (i1, i1) -> i1
    %rhs_max = "transfer.xor"(%rhs0, %all_ones) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %all_lt_bw = "transfer.cmp"(%rhs_max, %bitwidth) {predicate = 6 : i64} : (!transfer.integer, !transfer.integer) -> i1
    %may_ge_bw = "arith.xori"(%all_lt_bw, %const_true) : (i1, i1) -> i1
    %all_ge_bw = "transfer.cmp"(%rhs1, %bitwidth) {predicate = 9 : i64} : (!transfer.integer, !transfer.integer) -> i1
    ...
    %res1_safe = "transfer.select"(%may_ge_bw, %const0, %res1_final) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %lshr0 = "transfer.select"(%all_ge_bw, %all_ones, %res0_final) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %lshr1 = "transfer.select"(%all_ge_bw, %const0, %res1_safe) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer

    %out0 = "transfer.or"(%x0, %lshr0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %out1 = "transfer.and"(%x1, %lshr1) : (!transfer.integer, !transfer.integer) -> !transfer.integer

    %r = "transfer.make"(%out0, %out1) : (!transfer.integer, !transfer.integer) -> !transfer.abs_value<[!transfer.integer, !transfer.integer]>
    "func.return"(%r) : (!transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> ()
}) {"sym_name" = "kb_5_158932", "function_type" = (!transfer.abs_value<[!transfer.integer, !transfer.integer]>, !transfer.abs_value<[!transfer.integer, !transfer.integer]>, !transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> !transfer.abs_value<[!transfer.integer, !transfer.integer]>} : () -> ()
