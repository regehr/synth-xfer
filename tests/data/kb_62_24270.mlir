"func.func"() ({
  ^0(%s : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %z : !transfer.abs_value<[!transfer.integer, !transfer.integer]>):
    ...
    %out0 = "transfer.and"(%lhs0, %lshr0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %out1 = "transfer.or"(%lhs1, %lshr1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
...
}) {"sym_name" = "kb_62_24270", "function_type" = (!transfer.abs_value<[!transfer.integer, !transfer.integer]>, !transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> !transfer.abs_value<[!transfer.integer, !transfer.integer]>} : () -> ()
