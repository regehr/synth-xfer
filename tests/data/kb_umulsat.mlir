"func.func"() ({
  ^0(%lhs : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %rhs : !transfer.abs_value<[!transfer.integer, !transfer.integer]>):
    ...
    %mul0_base = "transfer.lshr"(%all_ones, %tz_sum_inv) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %mul1_base = "transfer.select"(%both_odd, %const1, %const0) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %lhs_bit1_zero = "transfer.and"(%lhs0, %bit1_mask) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %lhs_bit1_one = "transfer.and"(%lhs1, %bit1_mask) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %rhs_bit1_zero = "transfer.and"(%rhs0, %bit1_mask) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %rhs_bit1_one = "transfer.and"(%rhs1, %bit1_mask) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %mul0_base_precise = "transfer.or"(%mul0_base, %bit1_zero_odd) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %mul1_base_precise = "transfer.or"(%mul1_base, %bit1_one_odd) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %mul0_rhs_one = "transfer.select"(%rhs_is_one, %lhs0, %mul0_base_precise) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %mul1_rhs_one = "transfer.select"(%rhs_is_one, %lhs1, %mul1_base_precise) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %mul0_lhs_one = "transfer.select"(%lhs_is_one, %rhs0, %mul0_rhs_one) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %mul1_lhs_one = "transfer.select"(%lhs_is_one, %rhs1, %mul1_rhs_one) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %mul0 = "transfer.select"(%either_is_zero, %all_ones, %mul0_lhs_one) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %mul1 = "transfer.select"(%either_is_zero, %const0, %mul1_lhs_one) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %lhs_max_le_1 = "transfer.cmp"(%lhs_max, %const1) {predicate = 7 : i64} : (!transfer.integer, !transfer.integer) -> i1
    %rhs_max_le_1 = "transfer.cmp"(%rhs_max, %const1) {predicate = 7 : i64} : (!transfer.integer, !transfer.integer) -> i1

    %res0_noov = "transfer.select"(%never_overflow, %mul0, %const0) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %res0_sat = "transfer.select"(%always_overflow, %const0, %res0_noov) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %res1_sat = "transfer.select"(%always_overflow, %all_ones, %mul1) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %lhs01_res0 = "transfer.select"(%lhs_max_le_1, %rhs0, %const0) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %rhs01_res0 = "transfer.select"(%rhs_max_le_1, %lhs0, %const0) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %res0_sat_lhs01 = "transfer.or"(%res0_sat, %lhs01_res0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %res0_sat_small = "transfer.or"(%res0_sat_lhs01, %rhs01_res0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %bw_minus1 = "transfer.sub"(%bitwidth, %const1) : (!transfer.integer, !transfer.integer) -> !transfer.integer

    %rhs_minus1 = "transfer.sub"(%rhs1, %const1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %rhs_and_minus1 = "transfer.and"(%rhs1, %rhs_minus1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %rhs_nonzero = "transfer.cmp"(%rhs1, %const0) {predicate = 1 : i64} : (!transfer.integer, !transfer.integer) -> i1
    %rhs_pow2ish = "transfer.cmp"(%rhs_and_minus1, %const0) {predicate = 0 : i64} : (!transfer.integer, !transfer.integer) -> i1
    %rhs_pow2 = "arith.andi"(%rhs_nonzero, %rhs_pow2ish) : (i1, i1) -> i1
    %rhs_const_pow2 = "arith.andi"(%rhs_is_const, %rhs_pow2) : (i1, i1) -> i1
    %rhs_clz = "transfer.countl_zero"(%rhs1) : (!transfer.integer) -> !transfer.integer
    %rhs_k = "transfer.sub"(%bw_minus1, %rhs_clz) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %rhs_sh0 = "transfer.shl"(%lhs0, %rhs_k) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %rhs_sh1 = "transfer.shl"(%lhs1, %rhs_k) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %rhs_intro_mask = "transfer.shl"(%all_ones, %rhs_k) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %rhs_intro_zero = "transfer.xor"(%rhs_intro_mask, %all_ones) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %rhs_shl0 = "transfer.or"(%rhs_sh0, %rhs_intro_zero) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %rhs_pow2_max_ov = "transfer.umul_overflow"(%lhs_max, %rhs1) : (!transfer.integer, !transfer.integer) -> i1
    %rhs_pow2_never = "arith.xori"(%rhs_pow2_max_ov, %const_true) : (i1, i1) -> i1
    %rhs_pow2_min_ov = "transfer.umul_overflow"(%lhs1, %rhs1) : (!transfer.integer, !transfer.integer) -> i1
    %rhs_pow2_always = "arith.andi"(%lhs_min_nonzero, %rhs_pow2_min_ov) : (i1, i1) -> i1
    %rhs_pow2_noov0 = "transfer.select"(%rhs_pow2_never, %rhs_shl0, %const0) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %rhs_pow2_res0 = "transfer.select"(%rhs_pow2_always, %const0, %rhs_pow2_noov0) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %rhs_pow2_res1 = "transfer.select"(%rhs_pow2_always, %all_ones, %rhs_sh1) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer

    %lhs_minus1 = "transfer.sub"(%lhs1, %const1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %lhs_and_minus1 = "transfer.and"(%lhs1, %lhs_minus1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %lhs_nonzero = "transfer.cmp"(%lhs1, %const0) {predicate = 1 : i64} : (!transfer.integer, !transfer.integer) -> i1
    %lhs_pow2ish = "transfer.cmp"(%lhs_and_minus1, %const0) {predicate = 0 : i64} : (!transfer.integer, !transfer.integer) -> i1
    %lhs_pow2 = "arith.andi"(%lhs_nonzero, %lhs_pow2ish) : (i1, i1) -> i1
    %lhs_const_pow2 = "arith.andi"(%lhs_is_const, %lhs_pow2) : (i1, i1) -> i1
    %lhs_clz = "transfer.countl_zero"(%lhs1) : (!transfer.integer) -> !transfer.integer
    %lhs_k = "transfer.sub"(%bw_minus1, %lhs_clz) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %lhs_sh0 = "transfer.shl"(%rhs0, %lhs_k) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %lhs_sh1 = "transfer.shl"(%rhs1, %lhs_k) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %lhs_intro_mask = "transfer.shl"(%all_ones, %lhs_k) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %lhs_intro_zero = "transfer.xor"(%lhs_intro_mask, %all_ones) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %lhs_shl0 = "transfer.or"(%lhs_sh0, %lhs_intro_zero) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %lhs_pow2_max_ov = "transfer.umul_overflow"(%rhs_max, %lhs1) : (!transfer.integer, !transfer.integer) -> i1
    %lhs_pow2_never = "arith.xori"(%lhs_pow2_max_ov, %const_true) : (i1, i1) -> i1
    %lhs_pow2_min_ov = "transfer.umul_overflow"(%rhs1, %lhs1) : (!transfer.integer, !transfer.integer) -> i1
    %lhs_pow2_always = "arith.andi"(%rhs_min_nonzero, %lhs_pow2_min_ov) : (i1, i1) -> i1
    %lhs_pow2_noov0 = "transfer.select"(%lhs_pow2_never, %lhs_shl0, %const0) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %lhs_pow2_res0 = "transfer.select"(%lhs_pow2_always, %const0, %lhs_pow2_noov0) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %lhs_pow2_res1 = "transfer.select"(%lhs_pow2_always, %all_ones, %lhs_sh1) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %g0_raw = "transfer.and"(%const_val_not, %g_val1_not) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %h0_01 = "transfer.and"(%const_val_not, %h_val1_not) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %i0_raw = "transfer.and"(%const_val_not, %i_val1_not) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %j0_01 = "transfer.and"(%const_val_not, %j_val1_not) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %p0_01 = "transfer.and"(%const_val_not, %h_val1_not) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %q0_01 = "transfer.and"(%const_val_not, %g_val1_not) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %r31_mul = "transfer.mul"(%lhs_alt3, %rhs_alt1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %r31_ov = "transfer.umul_overflow"(%lhs_alt3, %rhs_alt1) : (!transfer.integer, !transfer.integer) -> i1
    %r31 = "transfer.select"(%r31_ov, %all_ones, %r31_mul) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %r32_mul = "transfer.mul"(%lhs_alt3, %rhs_alt2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %r32_ov = "transfer.umul_overflow"(%lhs_alt3, %rhs_alt2) : (!transfer.integer, !transfer.integer) -> i1
    %r32 = "transfer.select"(%r32_ov, %all_ones, %r32_mul) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %r33_mul = "transfer.mul"(%lhs_alt3, %rhs_alt3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %r33_ov = "transfer.umul_overflow"(%lhs_alt3, %rhs_alt3) : (!transfer.integer, !transfer.integer) -> i1
    %r33 = "transfer.select"(%r33_ov, %all_ones, %r33_mul) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %r0_01 = "transfer.and"(%const_val_not, %h_val1_not) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %r0_89 = "transfer.and"(%j_val2_not, %q11_not) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %r0_ab = "transfer.and"(%q12_not, %q13_not) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %r0_cd = "transfer.and"(%j_val3_not, %r31_not) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %r0_ef = "transfer.and"(%r32_not, %r33_not) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %r0_89ab = "transfer.and"(%r0_89, %r0_ab) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %r0_cdef = "transfer.and"(%r0_cd, %r0_ef) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %r0_0to7 = "transfer.and"(%r0_0123, %r0_4567) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %r0_8tof = "transfer.and"(%r0_89ab, %r0_cdef) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %r0_raw = "transfer.and"(%r0_0to7, %r0_8tof) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %r1_01 = "transfer.and"(%const_val, %h_val1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %r1_89 = "transfer.and"(%j_val2, %q11) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %r1_ab = "transfer.and"(%q12, %q13) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %r1_cd = "transfer.and"(%j_val3, %r31) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %r1_ef = "transfer.and"(%r32, %r33) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %r1_89ab = "transfer.and"(%r1_89, %r1_ab) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %r1_cdef = "transfer.and"(%r1_cd, %r1_ef) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %r1_0to7 = "transfer.and"(%r1_0123, %r1_4567) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %r1_8tof = "transfer.and"(%r1_89ab, %r1_cdef) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %r1_raw = "transfer.and"(%r1_0to7, %r1_8tof) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %n0_01 = "transfer.and"(%const_val_not, %g_val1_not) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %res0_sat_rhs_pow2 = "transfer.select"(%rhs_const_pow2, %rhs_pow2_res0, %res0_sat_small) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %res1_sat_rhs_pow2 = "transfer.select"(%rhs_const_pow2, %rhs_pow2_res1, %res1_sat) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %res0_sat_pow2 = "transfer.select"(%lhs_const_pow2, %lhs_pow2_res0, %res0_sat_rhs_pow2) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    %res1_sat_pow2 = "transfer.select"(%lhs_const_pow2, %lhs_pow2_res1, %res1_sat_rhs_pow2) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer

    %res0_g = "transfer.or"(%res0_sat_pow2, %g0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %res0_n = "transfer.or"(%res0_r, %n0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %res1_g = "transfer.or"(%res1_sat_pow2, %g1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %res1_n = "transfer.or"(%res1_r, %n1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
