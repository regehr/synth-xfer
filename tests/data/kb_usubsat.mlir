"func.func"() ({
  ^0(%lhs : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %rhs : !transfer.abs_value<[!transfer.integer, !transfer.integer]>):
    // usubsat(x, y) = ~uaddsat(~x, y); complement swaps KnownBits lanes.
    ...
    %add_res = "transfer.add"(%lhs1, %rhs1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %overflow = "transfer.uadd_overflow"(%lhs1, %rhs1) : (!transfer.integer, !transfer.integer) -> i1
    %const_res1 = "transfer.select"(%overflow, %all_ones, %add_res) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %r = "transfer.make"(%res1, %res0) : (!transfer.integer, !transfer.integer) -> !transfer.abs_value<[!transfer.integer, !transfer.integer]>
