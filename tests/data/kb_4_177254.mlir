"func.func"() ({
  ^0(%s : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %y : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %z : !transfer.abs_value<[!transfer.integer, !transfer.integer]>):
    %rhs0 = "transfer.get"(%s) {index = 0} : (!transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> !transfer.integer
    %rhs1 = "transfer.get"(%s) {index = 1} : (!transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> !transfer.integer
    ...
    %sub_all_ones = "transfer.get_all_ones"(%rhs0) : (!transfer.integer) -> !transfer.integer
    %one = "transfer.constant"(%rhs0) {value = 1 : index} : (!transfer.integer) -> !transfer.integer


    %sub1_lhs_max = "transfer.xor"(%z0, %sub_all_ones) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub1_rhs_max = "transfer.xor"(%y1, %sub_all_ones) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub1_sum_min = "transfer.add"(%z1, %y0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub1_sum_max = "transfer.add"(%sub1_lhs_max, %sub1_rhs_max) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub1_min_and = "transfer.and"(%z1, %y0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub1_min_or = "transfer.or"(%z1, %y0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub1_sum_min_not = "transfer.xor"(%sub1_sum_min, %sub_all_ones) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub1_min_or_and_sum_not = "transfer.and"(%sub1_min_or, %sub1_sum_min_not) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub1_carry_out_min = "transfer.or"(%sub1_min_and, %sub1_min_or_and_sum_not) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub1_max_and = "transfer.and"(%sub1_lhs_max, %sub1_rhs_max) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub1_max_or = "transfer.or"(%sub1_lhs_max, %sub1_rhs_max) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub1_sum_max_not = "transfer.xor"(%sub1_sum_max, %sub_all_ones) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub1_max_or_and_sum_not = "transfer.and"(%sub1_max_or, %sub1_sum_max_not) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub1_carry_out_max = "transfer.or"(%sub1_max_and, %sub1_max_or_and_sum_not) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub1_carry_one = "transfer.shl"(%sub1_carry_out_min, %one) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub1_carry_may_one = "transfer.shl"(%sub1_carry_out_max, %one) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub1_carry_zero = "transfer.xor"(%sub1_carry_may_one, %sub_all_ones) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub1_xor0_00 = "transfer.and"(%z0, %y1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub1_xor0_11 = "transfer.and"(%z1, %y0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub1_xor1_01 = "transfer.and"(%z0, %y0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub1_xor1_10 = "transfer.and"(%z1, %y1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub1_xor0 = "transfer.or"(%sub1_xor0_00, %sub1_xor0_11) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub1_xor1 = "transfer.or"(%sub1_xor1_01, %sub1_xor1_10) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub1_sum_xor0_00 = "transfer.and"(%sub1_xor0, %sub1_carry_zero) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub1_sum_xor0_11 = "transfer.and"(%sub1_xor1, %sub1_carry_one) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub1_sum_xor1_01 = "transfer.and"(%sub1_xor0, %sub1_carry_one) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub1_sum_xor1_10 = "transfer.and"(%sub1_xor1, %sub1_carry_zero) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub1_res0 = "transfer.or"(%sub1_sum_xor0_00, %sub1_sum_xor0_11) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub1_res1 = "transfer.or"(%sub1_sum_xor1_01, %sub1_sum_xor1_10) : (!transfer.integer, !transfer.integer) -> !transfer.integer

    %c1_0 = "transfer.xor"(%one, %sub_all_ones) : (!transfer.integer, !transfer.integer) -> !transfer.integer

    %sub2_lhs_max = "transfer.xor"(%sub1_res0, %sub_all_ones) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub2_rhs_max = "transfer.xor"(%c1_0, %sub_all_ones) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub2_sum_min = "transfer.add"(%sub1_res1, %one) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub2_sum_max = "transfer.add"(%sub2_lhs_max, %sub2_rhs_max) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub2_min_and = "transfer.and"(%sub1_res1, %one) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub2_min_or = "transfer.or"(%sub1_res1, %one) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub2_sum_min_not = "transfer.xor"(%sub2_sum_min, %sub_all_ones) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub2_min_or_and_sum_not = "transfer.and"(%sub2_min_or, %sub2_sum_min_not) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub2_carry_out_min = "transfer.or"(%sub2_min_and, %sub2_min_or_and_sum_not) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub2_max_and = "transfer.and"(%sub2_lhs_max, %sub2_rhs_max) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub2_max_or = "transfer.or"(%sub2_lhs_max, %sub2_rhs_max) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub2_sum_max_not = "transfer.xor"(%sub2_sum_max, %sub_all_ones) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub2_max_or_and_sum_not = "transfer.and"(%sub2_max_or, %sub2_sum_max_not) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub2_carry_out_max = "transfer.or"(%sub2_max_and, %sub2_max_or_and_sum_not) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub2_carry_one = "transfer.shl"(%sub2_carry_out_min, %one) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub2_carry_may_one = "transfer.shl"(%sub2_carry_out_max, %one) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub2_carry_zero = "transfer.xor"(%sub2_carry_may_one, %sub_all_ones) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub2_xor0_00 = "transfer.and"(%sub1_res0, %c1_0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub2_xor0_11 = "transfer.and"(%sub1_res1, %one) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub2_xor1_01 = "transfer.and"(%sub1_res0, %one) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub2_xor1_10 = "transfer.and"(%sub1_res1, %c1_0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub2_xor0 = "transfer.or"(%sub2_xor0_00, %sub2_xor0_11) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub2_xor1 = "transfer.or"(%sub2_xor1_01, %sub2_xor1_10) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub2_sum_xor0_00 = "transfer.and"(%sub2_xor0, %sub2_carry_zero) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub2_sum_xor0_11 = "transfer.and"(%sub2_xor1, %sub2_carry_one) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub2_sum_xor1_01 = "transfer.and"(%sub2_xor0, %sub2_carry_one) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sub2_sum_xor1_10 = "transfer.and"(%sub2_xor1, %sub2_carry_zero) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %lhs0 = "transfer.or"(%sub2_sum_xor0_00, %sub2_sum_xor0_11) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %lhs1 = "transfer.or"(%sub2_sum_xor1_01, %sub2_sum_xor1_10) : (!transfer.integer, !transfer.integer) -> !transfer.integer
...
}) {"sym_name" = "kb_4_177254", "function_type" = (!transfer.abs_value<[!transfer.integer, !transfer.integer]>, !transfer.abs_value<[!transfer.integer, !transfer.integer]>, !transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> !transfer.abs_value<[!transfer.integer, !transfer.integer]>} : () -> ()
