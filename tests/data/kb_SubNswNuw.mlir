"func.func"() ({
  ^0(%lhs : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %rhs : !transfer.abs_value<[!transfer.integer, !transfer.integer]>):
    ...
    %res0_refined3 = "transfer.or"(%res0_refined2, %res_sign0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %res1_refined3 = "transfer.or"(%res1_refined2, %res_sign1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
...
}) {"sym_name" = "kb_subnswnuw", "function_type" = (!transfer.abs_value<[!transfer.integer, !transfer.integer]>, !transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> !transfer.abs_value<[!transfer.integer, !transfer.integer]>} : () -> ()
