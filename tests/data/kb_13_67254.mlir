"func.func"() ({
  ^0(%lhs : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %rhs : !transfer.abs_value<[!transfer.integer, !transfer.integer]>):
    ...
    %sum0 = "transfer.or"(%xor0_sum_carry_00, %xor0_sum_carry_11) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %sum1 = "transfer.or"(%xor1_sum_carry_01, %xor1_sum_carry_10) : (!transfer.integer, !transfer.integer) -> !transfer.integer

    %res0_old = "transfer.or"(%sum0, %rhs0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %res1_old = "transfer.and"(%sum1, %rhs1) : (!transfer.integer, !transfer.integer) -> !transfer.integer

    %x_xor_c_00 = "transfer.and"(%lhs0, %carry_zero) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %x_xor_c_11 = "transfer.and"(%lhs1, %carry_one) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %x_xor_c_01 = "transfer.and"(%lhs0, %carry_one) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %x_xor_c_10 = "transfer.and"(%lhs1, %carry_zero) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %x_xor_c_0 = "transfer.or"(%x_xor_c_00, %x_xor_c_11) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %x_xor_c_1 = "transfer.or"(%x_xor_c_01, %x_xor_c_10) : (!transfer.integer, !transfer.integer) -> !transfer.integer

    %res0_new = "transfer.or"(%rhs0, %x_xor_c_1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %res1_new = "transfer.and"(%rhs1, %x_xor_c_0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
...
}) {"sym_name" = "kb_13_67254", "function_type" = (!transfer.abs_value<[!transfer.integer, !transfer.integer]>, !transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> !transfer.abs_value<[!transfer.integer, !transfer.integer]>} : () -> ()
