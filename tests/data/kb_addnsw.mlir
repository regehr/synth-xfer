"func.func"() ({
  ^0(%lhs : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %rhs : !transfer.abs_value<[!transfer.integer, !transfer.integer]>):
    ...
    %signmask = "transfer.shl"(%const1, %bw_minus_1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %not_signmask = "transfer.xor"(%signmask, %all_ones) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %lhs_sign_can_be_one = "transfer.and"(%lhs_max, %signmask) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %rhs_sign_can_be_one = "transfer.and"(%rhs_max, %signmask) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %lhs_upper_max = "transfer.and"(%lhs_max, %not_signmask) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %rhs_upper_max = "transfer.and"(%rhs_max, %not_signmask) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %lhs_sign_is_one = "transfer.and"(%lhs1, %signmask) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %rhs_sign_is_one = "transfer.and"(%rhs1, %signmask) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %lhs_smax_is_neg = "transfer.cmp"(%lhs_smax, %const0) {predicate = 2 : i64} : (!transfer.integer, !transfer.integer) -> i1
    ...
    %min_ones_no_sign = "transfer.and"(%min_high_mask, %not_signmask) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %max_zeros_no_sign = "transfer.and"(%max_high_mask, %not_signmask) : (!transfer.integer, !transfer.integer) -> !transfer.integer

    %nsw_zero_from_min = "transfer.select"(%min_non_neg, %signmask, %const0) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %nsw_one_from_max = "transfer.select"(%max_is_neg, %signmask, %const0) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
