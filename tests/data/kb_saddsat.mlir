"func.func"() ({
  ^0(%lhs : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %rhs : !transfer.abs_value<[!transfer.integer, !transfer.integer]>):
    ...
    %overflow = "transfer.sadd_overflow"(%lhs1, %rhs1) : (!transfer.integer, !transfer.integer) -> i1
    ...
    %const_res1 = "transfer.select"(%overflow, %sat_res, %add_res) : (i1, !transfer.integer, !transfer.integer) -> !transfer.integer
