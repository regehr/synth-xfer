"builtin.module"() ({
  "func.func"() ({
  ^bb0(%a: !transfer.integer, %b: !transfer.integer, %s: !transfer.integer):
    ...
    %lshr_part = "transfer.lshr"(%b, %inv_k) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %res = "transfer.or"(%shl_part, %lshr_part) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    "func.return"(%res) : (!transfer.integer) -> ()
  }) {function_type = (!transfer.integer,!transfer.integer,!transfer.integer) -> !transfer.integer, sym_name = "concrete_op"} : () -> ()
}): () -> ()
